...
// function Model(props) {
  ...
  //     if (!unchangeableMaterials.includes(name)) {
  ...
  //       if (child.isMesh) {
  //         Object.assign(loadedMaterials, child.material);
  //       }
  //     });
  ...
  //     gltf.scene.traverse((child) => {
  //       if (child.isMesh) {
  //         loadedNodes[child.name] = child;
  //         loadedMaterials[child.material.name] = child.material;
  //       }
  //     });
...
//   useEffect(() => {
//     const loader = new GLTFLoader();
//     loader.load("/assets/images/scene.glb", (gltf) => {
//       const loadedNodes = {};
//       const loadedMaterials = {};
//       gltf.scene.traverse((child) => {
//         if (child.isMesh) {
...
function Model(props) {
  const { nodes, materials } = useGLTF("/assets/images/scene.glb");
